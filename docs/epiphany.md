...
彼时KDE团队的KHTML内核还被GNOME社群视为异端，因此Epiphany还是继承了Galeon的[Gecko](gecko.md)内核。孰料天有不测风云，同期苹果分叉KHTML搞出的[WebKit](webkit.md)内核，在iPhone大卖之后成为了开源界的香饽饽。无奈之下，2007年Epiphany决定加入由[Midori](midori.md)发起的WebKitGTK项目，并于2009年发布的2.8版本正式完成切换。
