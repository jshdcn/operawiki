...
受网景影响，早期浏览器很多都带有自己的扩展机制，如Mozilla的XUL、Opera的[Opera扩展](extension.md)等，虽然前者将其称为Add-ons，而后者将其称为Extensions，所指含义为一。其中Mozilla的扩展机制，诞生了Adblock Plus、ChatZilla、Firebug、Lightning、Sage、SimpleMail、SQLite Manager等身怀绝艺、装机必备的著名扩展，甚至成为了用户选择Firefox的一大理由。
...
各家的兼容模式略有差别，如Opera一度彻底放弃了自己的扩展商店，完全兼容Google的，直至Opera 20才恢复双重兼容，Edge既兼容Chrome Web Store，同时也维护了自己的扩展商店，Firefox则仅仅是在[API](api.md)层面复制了Blink extension，而维持了独立自主的Add-ons商店和xpi包装格式。