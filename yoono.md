...
Yoono是一个社交扩展，现可用于Chrome、Firefox、SeaMonkey（称附加组件）和IE（称加载项）。就浏览器而论，粗略地说它安装在Firefox上的效果可以相当于Flock；就扩展而论，Yoono大约是Meebo、Xmarks、Twitterfox、Facebook Toolbar等的集合体。在一个侧边栏中支持多种聊天协议、微博客、社交网站乃至书签同步。曾在很长时间内成为Firefox官方推荐的社交扩展。
